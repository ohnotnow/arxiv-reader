...
tailwind = Script(src="https://cdn.tailwindcss.com?plugins=typography,forms")
            ...
            Div(
                ...
                Select(
                    *opts,
                    ...
                    cls=(
                        "flex-1 min-w-0 border rounded p-2 pr-10 border-slate-300 bg-white text-slate-900 "
                        "dark:bg-slate-900 dark:text-slate-100 dark:border-slate-700"
                    ),
                ),
                Button(
